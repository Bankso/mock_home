...
## Usage: sbatch all_start.sh 1 2 3 4
## Requires four inputs at the command line:
	## For start bash script:
		...
		## Second input - Path to R script for processing
		## Third input - Name of job (i.e., Gal4_chec or something like that) for sbatch log files
